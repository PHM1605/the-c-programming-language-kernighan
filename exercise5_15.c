...
// for example, a and A are equal
// gcc exercise5_15.c -o exercise5_15
// ./exercise5_15 -f < exercise5_15_input.txt
#include <stdio.h>
#include <string.h>
#include <stdlib.h>
#include <ctype.h>
...
int main(int argc, char* argv[]) {
    ...
    int fold = 0; // 0: uppercase and lowercase are different; 1: uppercase and lowercase are similar
